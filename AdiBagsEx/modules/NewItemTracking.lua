...
local addon = LibStub('AceAddon-3.0'):GetAddon(...)
...
function mod:OnInitialize()
	-- Database will be initialized in OnEnable after main addon is ready
end
...
local function ResetButton_OnClick(widget, button)
	...
	wipe(newItems)
	mod.button:Disable()
	mod:SendMessage('AdiBagsEx_FiltersChanged', true)
