...
-- Warbound Bank strings (added for WoW 11.0+)
L["Warbound Bank Tab 1"] = true
L["Warbound Bank Tab 2"] = true
L["Warbound Bank Tab 3"] = true
L["Warbound Bank Tab 4"] = true
L["Warbound Bank Tab 5"] = true
...
-- BoundItems Filter
L["Bound Items"] = true
L["Put bound gear items (BOE/BOP/Warbound) in their own sections."] = true
L["Bind on Equip"] = true
L["Bind on Pickup"] = true
L["Warbound"] = true
L["Equipment only"] = true
L["Only apply binding filters to equipment items (weapons, armor, accessories)."] = true
L["Use Modern Detection"] = true
L["Use advanced binding detection for more accurate warbound vs soulbound identification."] = true
L["Separate BOE items"] = true
L["Put \"Bind on Equip\" items in their own section."] = true
L["Separate BOP items"] = true
L["Put \"Bind on Pickup\" items in their own section."] = true
L["Separate Warbound items"] = true
L["Put \"Warbound\" items in their own section."] = true
L["Separate Soulbound items"] = true
L["Put \"Soulbound\" items in their own section (requires modern detection)."] = true

-- Modern Binding Types
L["No Binding"] = true
L["Bind on Use"] = true
L["Battle.net Account Bound"] = true
L["Bound"] = true
L["Soulbound"] = true
L["Refundable"] = true
L["Quest Item"] = true
...
-- Warbound Bank French translations
L["Warbound Bank Tab 1"] = "Banque liée 1"
L["Warbound Bank Tab 2"] = "Banque liée 2" 
L["Warbound Bank Tab 3"] = "Banque liée 3"
L["Warbound Bank Tab 4"] = "Banque liée 4"
L["Warbound Bank Tab 5"] = "Banque liée 5"
L["Border"] = "Bord"
