...
function bagAnchorProto:OnCreate(parent, name, label)
	...
	self:RegisterMessage('AdiBagsEx_ConfigChanged')
...
function bagAnchorProto:AdiBagsEx_ConfigChanged(_, name)
...
function bagAnchorProto:OnClick(mouseButton)
	if mouseButton == "RightButton" then
		if IsAltKeyDown() then
			...
			addon:SendMessage('AdiBagsEx_ConfigChanged', 'positionMode')
